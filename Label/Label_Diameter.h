#ifndef _Label_Diameter_HeaderFile
#define _Label_Diameter_HeaderFile

#include "Label_PMI.h"

//! Presentation of the text.
class Label_Diameter : public Label_PMI
{
public:
    ...
    Label_Diameter(const NCollection_Utf8StringList& values,
...
public:
    ...
    //! CASCADE RTTI
    DEFINE_STANDARD_RTTIEXT(Label_Diameter,Label_PMI)

};

DEFINE_STANDARD_HANDLE(Label_Diameter, Label_PMI)

#endif // _Label_Diameter_HeaderFile
